<template>
  <div class="mt-6 p-6 bg-gray-50 border border-gray-200 rounded-lg">
    ...
    <p class="text-gray-700">
      Interested in collaborating or hiring? Reach out via:
    </p>
      ...
      <li>
        <div class="flex items-center space-x-2">
          ...
          <a href="https://www.upwork.com/freelancers/mikhaila"
             target="_blank"
             class="text-blue-500 hover:underline">upwork.com/freelancers/mikhaila</a>
        </div>
      </li>
      <li>
        <div class="flex items-center space-x-2">
          ...
          <a href="https://github.com/landofcash"
             target="_blank"
             class="text-blue-500 hover:underline">github.com/landofcash</a>
        </div>
      </li>
    </ul>
  </div>
